    ...
    <div className='space-y-8'>
      <div>
        ...
        <p className='text-text-body dark:text-slate-300'>
          Manage your freelance invoices and payments
        </p>
      </div>
        ...
        <CardBody>
          <div className='text-center py-12'>
            ...
            <p className='text-text-body dark:text-slate-300 max-w-md mx-auto'>
              We're building a complete invoice management system where you can
              create, send, and track your freelance invoices with automated
              payment reminders.
            </p>
          </div>
        </CardBody>
