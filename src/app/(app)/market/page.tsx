  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-text-body dark:text-slate-300">Real-time freelance market data and trends</p>
      </div>
        ...
        <CardBody>
          <div className="text-center py-12">
            ...
            <p className="text-text-body dark:text-slate-300 max-w-md mx-auto">
              We&apos;re building a comprehensive market insights dashboard with real-time data, trends analysis, and
              rate comparisons for the Egyptian freelance market.
            </p>
          </div>
        </CardBody>
      </Card>
