        ...
        <div className="flex items-center justify-between h-16 px-4 lg:px-8 max-w-7xl mx-auto">
          <Link href="/" className="flex items-center space-x-3">
            <Image
              ...
              className="h-8 w-8"
            />
            <span className="text-lg sm:text-xl font-bold text-text-main dark:text-slate-100">Qeem</span>
          </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-12 lg:gap-16 items-center min-h-[calc(100vh-4rem)] px-4 lg:px-8 py-12 lg:py-20 max-w-7xl mx-auto w-full">
          <div className="max-w-2xl">
            ...
            <p className="text-lg sm:text-xl text-text-body dark:text-slate-300 mb-8 leading-relaxed max-w-xl">
              Discover your true worth and negotiate with confidence using data-driven insights. Get personalized rate
              recommendations based on your skills, experience, and market conditions.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-6 pt-6 border-t border-border dark:border-slate-600">
              <div>
                ...
                <div className="text-xs sm:text-sm text-text-muted dark:text-slate-400">Freelancers</div>
              </div>
              <div>
                <div className="text-xl sm:text-2xl font-bold text-accent">95%</div>
                <div className="text-xs sm:text-sm text-text-muted dark:text-slate-400">Accuracy</div>
              </div>
              <div>
                <div className="text-xl sm:text-2xl font-bold text-accent">₦50M+</div>
                <div className="text-xs sm:text-sm text-text-muted dark:text-slate-400">Saved</div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:order-first">
            <div className="relative">
              ...
              <Card className="bg-surface dark:bg-slate-800 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <CardBody>
                  <h2 className="text-2xl font-bold text-text-main dark:text-slate-100 mb-6">Why Choose Qeem?</h2>
                  <ul className="space-y-4">
                    <li className="flex items-center gap-3 text-text-body dark:text-slate-300 group">
                      ...
                      <div>
                        <div className="font-semibold">AI-Powered Calculations</div>
                    ...
                    <li className="flex items-center gap-3 text-text-body dark:text-slate-300 group">
                      ...
                      <div>
                        <div className="font-semibold">Real-time Market Data</div>
                        <div className="text-sm text-text-muted dark:text-slate-400">
                    ...
                    <li className="flex items-center gap-3 text-text-body dark:text-slate-300 group">
                      ...
                      <div>
                        <div className="font-semibold">Negotiation Strategies</div>
                        <div className="text-sm text-text-muted dark:text-slate-400">
                    ...
                    <li className="flex items-center gap-3 text-text-body dark:text-slate-300 group">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-text-muted dark:text-slate-400">Invoices, contracts, and more</div>
                      </div>
                    </li>
                  </ul>
                </CardBody>
              ...
              <div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 w-16 h-16 sm:w-20 sm:h-20 bg-accent/10 rounded-full animate-pulse" />
              <div className="absolute -bottom-2 -left-2 sm:-bottom-4 sm:-left-4 w-12 h-12 sm:w-16 sm:h-16 bg-accent/5 rounded-full animate-pulse delay-1000" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg sm:text-xl text-text-body dark:text-slate-300 max-w-2xl mx-auto">
              From rate calculation to contract management, we&apos;ve got you covered.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardBody>
                ...
                <h3 className="text-xl font-bold text-text-main dark:text-slate-100 mb-2">Smart Calculator</h3>
                <p className="text-text-body dark:text-slate-300">
                  Get personalized rate recommendations based on your skills and market conditions.
                </p>
              </CardBody>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardBody>
                ...
                <h3 className="text-xl font-bold text-text-main dark:text-slate-100 mb-2">Market Insights</h3>
                <p className="text-text-body dark:text-slate-300">
                  Access real-time data on freelance rates across different industries in Egypt.
                </p>
              </CardBody>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardBody>
                ...
                <h3 className="text-xl font-bold text-text-main dark:text-slate-100 mb-2">Quick Start</h3>
                <p className="text-text-body dark:text-slate-300">
                  Get your rates in seconds. No complex setup, just accurate results.
                </p>
              </CardBody>
            </Card>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-accent/5 to-accent-dark/5 dark:from-accent/10 dark:to-accent-dark/10">
        <div className="max-w-4xl mx-auto text-center px-4 lg:px-8">
          ...
          <p className="text-lg sm:text-xl text-text-body dark:text-slate-300 mb-8 max-w-2xl mx-auto">
            Join thousands of freelancers who are already earning what they deserve.
          </p>
          <Link href="/calculator">
            <Button size="lg" className="group">
